...
public partial class ChinookContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasOne(d => d.SupportRepresentative).WithMany(p => p.SupportRepresentativeCustomers).HasForeignKey(d => d.SupportRepId);
        });
        ...
        modelBuilder.Entity<Track>(entity =>
        {
            ...
            entity.HasOne(d => d.Album).WithMany(p => p.AlbumTracks).HasForeignKey(d => d.AlbumId);

            entity.HasOne(d => d.Genre).WithMany(p => p.GenreTracks).HasForeignKey(d => d.GenreId);
